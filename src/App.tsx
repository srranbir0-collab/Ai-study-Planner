  ...
  const generatePlan = async () => {
    ...
    try {
      ...
      const promptText = `
        ...
        - Target Date (Exam/Goal): ${format(examDate, "yyyy-MM-dd")}
        ...
        Distribute the topics logically across the available days leading up to the target date starting from today.
      ...
      const newPlan: StudyPlan = {
        ...
        title: `Plan for ${format(examDate, "MMM d, yyyy")} (${subjects.length} subjects)`,
          ...
          <div className="lg:col-span-1 space-y-6 no-print">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label>Target Date (Exam or Goal)</Label>
                  <Popover>
